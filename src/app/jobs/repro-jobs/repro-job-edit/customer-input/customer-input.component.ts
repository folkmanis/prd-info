...
@Component({
    ...
    standalone: true,
    imports: [MatFormFieldModule, MatInputModule, FormsModule, MatAutocompleteModule, ReactiveFormsModule, MatButtonModule, MatIconModule, NgIf, NgFor, MatOptionModule, AsyncPipe]
})
