...
export const threadsQueryToFilter = z.codec(ThreadsQuerySchema, ThreadsFilterSchema, {
  encode: (filter) => ({
    ...filter,
  ...
  decode: (query) => ({
    ...query,
    labelIds: typeof query.labelIds === 'string' ? query.labelIds.split(',') : undefined,
    maxResults: query.maxResults ? Number.parseInt(query.maxResults) : undefined,
  }),
});
