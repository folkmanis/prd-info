...
import { SystemPreferences } from '../library/classes/system-preferences-class';
...
export class LoginHttpService {
  ...
  getAllSystemPreferencesHttp(): Observable<SystemPreferences> {
    return this.http.get<SystemPreferences>(this.httpPathPreferences + 'all', new HttpOptions());
  }
