...
export const USER_MODULES: UserModule[] = [
  ...
  { name: 'Pievienot XMF arhīvu', description: 'XFM arhīva jaunināšana', route: 'xmf-upload' },
  {
    ...
    childMenu: [
      ...
      { name: 'Visi darbi', route: 'job-list', description: 'Saraksts ar visiem darbiem un meklēšana' },
    ],
  },
  {
    name: 'Aprēķini',
    description: 'Kalkulācijas un rēķini',
    route: 'calculations',
    childMenu: [
  ...
  {
    name: 'Darbu iestatījumi',
    description: 'Ražošanas darbu moduļa iestatījumi',
    route: 'jobs-admin',
    childMenu: [
  ...
  {
    name: 'Pakošana kastēs',
    description: 'Pakošanas saraksti perforācijai',
    route: 'kastes',
    childMenu: [
